...
if (isset($_POST['edit'])) {
    ...
    $sql_edit = "UPDATE instruktur SET nama='$nama', spesialis='$spesialis' WHERE id_instruktur=$id_instruktur";
    $conn->query($sql_edit);
...
<body>
    <div class="container">
        ...
        <form action="" method="POST">
            ...
            <input type="text" name="nama" value="<?= $row['nama']; ?>" placeholder="Nama Instruktur" required>
            <input type="text" name="spesialis" value="<?= $row['spesialis']; ?>" placeholder="Spesialis Instruktur" required>
